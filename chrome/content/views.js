 ...
 * @class ImageHandlerChrome.ImageGrid
 * @constructor
 * @param {String}
 ...
 */
ImageHandlerChrome.ImageGrid = function(imageContainerId, gridWidth, thumbnailType, isShowImageSize, isShowImageName) {
...
ImageHandlerChrome.ImageGrid.prototype = {
         ...
         if (imgInfo) {
            ...
            cellBox.addEventListener("click", function(event){
                if (event.button == 0) { //Left mouse button click
                    ImageHandlerChrome.Controller.handleClickOnImage(imgInfo.id);
                }
            }, false);
