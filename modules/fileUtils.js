...
/**
 * Provides the file utilities and extensions used by the ImageHandler
 *
 * @namespace ImageHandler
 * @class ImageHandler.FileUtils
 */
ImageHandler.FileUtils = {
    ...
    revealDirectory : function(directory) {
        ...
        try {
            ...
            ImageHandler.Logger.error("Cannot open directory for " + directory, e);
        }
    },
    ...
    toValidName : function(originalName) {
        ...
        if (originalName.length != validName.length) {
            ImageHandler.Logger.info("convert " + originalName + " to valid directory/file name: " + validName);
        }
    ...
    createFolder : function(parentDirPath, subFolderName) {
        ...
        try {
            ...
            ImageHandler.Logger.warn("Cannot create subfolder: " + e);
        }
    ...
    makeFolderNameByTitle : function(docTitle) {
        ...
        var textLines = ImageHandler.Settings.getRemoveTextFromTitle();
